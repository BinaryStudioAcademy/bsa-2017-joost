    ...
    public class EmailService
    {
        ...
        public Guid SendEmail(LoginDto user)
        {
            try
            {
                ...
                + $"<a style='color:#0074b1 !important;text-decoration:none;'>{user.Email}</a>" 
                + $" to activate your account:"
                + $"</p><p style='text-align:center;'>" 
                + $"<a href='{url}confirm-registration?key={key.ToString()}' style='display:inline-block;background-color:#0074b1;padding:15px 60px ;margin-top:20px;text-decoration:none;color:white;margin-bottom:25px;border-radius:3px;'><strong>CONFIRM</strong></a>" 
                ...
                + $"<a href='{url}confirm-registration?key={key.ToString()}' style='margin-bottom:20px;text-decoration:underline;color:#0074b1;'>{url}confirm-registration?key={key.ToString()}</a></td>" 
                + "</tr><tr><td style='text-align:center;padding-bottom:20px;font-size:0.85em;padding-top:0px;'> Have a question? Contact us: "
                + "<a href='mailto:joost.supp0rt@gmail.com' style='text-decoration:none;color:#0074b1;text-decoration:underline;'>joost.supp0rt@gmail.com</a>"
